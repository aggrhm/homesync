...
" Syntax group
highlight Comment    gui=none guifg=#00944A guibg=bg      ctermfg=2
highlight Constant   gui=bold guifg=#0000FF guibg=bg      ctermfg=White
highlight Error      gui=none guifg=#f8f8f8 guibg=#ff0000 term=reverse        ctermbg=Red    ctermfg=White
...
highlight Todo       gui=bold guifg=#ff5050 guibg=white   term=standout       ctermbg=Yellow ctermfg=Black
